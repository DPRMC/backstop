...
trait HedgeFundAccountRedemptions {
    ...
    public function hedge_fund_subscriptions_by_filter( string $filterField,
                                                      string $filterOperator,
                                                      string $filterValue,
                                                      string $sortField ): array {
        ...
        $uri = '/backstop/api/hedge-fund-account-subscriptions/';
        ...
        $subscriptions = [];
        foreach ( $jsonArray[ 'data' ] as $row ):
            //$subscriptions[] = new HedgeFundAccountSubscription( $row );
            $subscriptions[] = $row;
        endforeach;
